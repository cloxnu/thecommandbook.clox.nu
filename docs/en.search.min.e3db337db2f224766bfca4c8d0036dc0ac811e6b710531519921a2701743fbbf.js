...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.84befaa8d4047f75da7787aa7659a3e1be48b04b78f23723dafdaf5b18ff54cd.js',function(){input.required=false;search();});}
