...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6d8a87d56eb691a59dcc7a35ba0ae526dab853dd22986c8d0b017953770669bc.js',function(){input.required=false;search();});}
