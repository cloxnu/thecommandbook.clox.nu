...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6e8a9a7cb2bbe78b72bf5bd040dee2947c81553cda8dd29bb4f60afd5e5a2faa.js',function(){input.required=false;search();});}
