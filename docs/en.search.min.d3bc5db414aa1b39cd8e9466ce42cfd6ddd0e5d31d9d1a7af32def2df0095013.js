...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.97119d1b7e7f6de25a904f297c2630f6c2e7a5224f118a4332a9c67b67f55dcc.js',function(){input.required=false;search();});}
