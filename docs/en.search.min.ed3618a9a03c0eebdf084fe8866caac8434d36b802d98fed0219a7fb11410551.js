...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9a0d1caf5acc7ed9732080f0142bfe9f8a1586cff0a8692f8873c815022c652f.js',function(){input.required=false;search();});}
