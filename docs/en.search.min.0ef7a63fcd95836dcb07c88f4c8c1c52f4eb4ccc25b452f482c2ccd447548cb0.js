...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9e59dc7790249023892c2d1d5e7c4b1f6bfc47c95742f54d18225f26dda2a3c5.js',function(){input.required=false;search();});}
