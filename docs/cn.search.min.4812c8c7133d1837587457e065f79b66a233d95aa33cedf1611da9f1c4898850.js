...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/cn.search-data.min.7e01242d8b249e35e2a8feeca3b578322204081feaa7ffa77e77ee22d9c0605b.js',function(){input.required=false;search();});}
